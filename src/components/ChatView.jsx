    ...
    <div className={`view ${isActive ? 'active' : ''}`}>
        <div className="flex justify-between items-end mb-8">
            <div>
                ...
                <p className="text-text-muted">Chat kontekstual berbasis Azure OpenAI. AI memahami profil dan target karir Anda.</p>
            </div>
            <div className="inline-flex items-center gap-1.5 bg-[#E6F1FB] text-[#0C447C] text-xs px-3 py-1.5 rounded-full font-medium border border-[#0C447C]/10 m-0">
                <i className="ph-fill ph-microsoft-logo text-[#0078D4]"></i> Azure OpenAI GPT-4o
            </div>
        </div>
