        ...
        <div className="flex items-center gap-6 mb-6 md:mb-0">
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="bg-green-100 text-green-700 text-[11px] font-bold px-3 py-1 rounded-sm">Waktu Penuh</span>
              <span className="bg-red-100 text-red-700 text-[11px] font-bold px-3 py-1 rounded-sm">Populer</span>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-10">
            <section>
              ...
              <div className="text-text-muted leading-relaxed space-y-4 text-[15px]">
                <p>Kami mencari Senior UX Designer yang berpengalaman untuk bergabung dengan tim kami di Facebook. Anda akan bertanggung jawab untuk menciptakan pengalaman pengguna yang luar biasa bagi miliaran orang di seluruh dunia.</p>
                <p>Anda akan bekerja sama dengan tim lintas fungsi, termasuk manajer produk, insinyur, dan peneliti, untuk mendefinisikan dan menerapkan solusi desain yang inovatif untuk arah produk dan pengalaman pengguna.</p>
                <p>Sebagai desainer senior, Anda juga diharapkan dapat membimbing desainer junior dan berkontribusi pada pengembangan sistem desain global kami.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="grid grid-cols-1 gap-4 text-text-muted text-[15px]">
                {[
                  'Minimal 5 tahun pengalaman sebagai UX Designer atau peran serupa.',
                  'Portofolio yang kuat yang menunjukkan kemahiran dalam memecahkan masalah UX yang kompleks.',
                  'Keahlian mendalam dalam alat desain seperti Figma, Sketch, atau Adobe XD.',
                  'Pemahaman yang baik tentang desain sistem dan aksesibilitas web.',
                  'Kemampuan komunikasi yang luar biasa dan pengalaman bekerja dalam tim Agile.'
                ].map((item, i) => (
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white p-6 rounded-xl border border-gray-100 text-center shadow-sm">
              ...
              <div className="text-accent font-bold text-xl">Rp 30jt - 45jt</div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-100 shadow-sm">
            ...
            <div className="space-y-6">
              {[
                { icon: 'ph-calendar-blank', label: 'Diposting', value: '14 Jun, 2024' },
                { icon: 'ph-hourglass', label: 'Berakhir', value: '14 Agu, 2024' },
                { icon: 'ph-chart-line-up', label: 'Tingkat', value: 'Senior Level' },
                { icon: 'ph-briefcase-metal', label: 'Pengalaman', value: '5+ Tahun' },
